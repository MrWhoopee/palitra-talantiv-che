    ...
    <>
      <header className="admin-head">
        ...
        <p className="admin-lede">
          Усі групи студії з наповненістю. Створює й змінює групу викладач у своєму кабінеті — там
          же складається розклад зустрічей. Заявки на вступ розглядаються на{' '}
