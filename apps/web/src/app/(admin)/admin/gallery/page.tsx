    ...
    <>
      <header className="admin-head">
        ...
        <p className="admin-lede">
          Фото зі студії й відео з YouTube, у тому порядку, в якому їх побачать. Стрілки переставляють
          картку на одну позицію — миші тягати не треба, і з клавіатури це теж працює.
        </p>
      </header>
